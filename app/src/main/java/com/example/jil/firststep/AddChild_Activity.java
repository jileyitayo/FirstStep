...
public class AddChild_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        childApp = new DAOChildApp(getApplicationContext());
        healthApp = new DAOHealthApp(getApplicationContext());
    ...
    public void submitDetails()
    {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                child = getChildFromLayout(owner, etFirstName.getText().toString(), etLastName.getText().toString(), etGender.getText().toString(), tvDate.toString());
    ...
    private Child getChildFromLayout(Users user, String firstName, String lastName, String gender ,String DOB) {
        Child child1 = new Child();
        child1.setFirstName(firstName);
        child1.setLastName(lastName);
        child1.setGender(gender);
        child1.setDateOfBirth(DOB);
        child1.setUserId(user.getId());
        child1.setUsername(user.getUsername());
        return child1;
    }
